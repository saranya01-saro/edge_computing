...
parser.add_argument('--root-ca', help="File path to root certificate authority, in PEM format. " +
                                      ...
                                      "your trust store.")
parser.add_argument('--client-id', default="sample" + str(uuid4()), help="Client ID for MQTT connection.")
parser.add_argument('--topic', default="publish", help="Topic to subscribe to, and publish messages to.")
...
if __name__ == '__main__':
    ...
    if args.message:
        ...
        while (publish_count <= args.count) or (args.count == 0):
            message = {}
            message['temperature'] = str(random.randint(-10,150))
            message['Moisture'] = str(random.randint(0,100))
